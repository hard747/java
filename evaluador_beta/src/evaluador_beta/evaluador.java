...
public class evaluador extends javax.swing.JFrame {
   ...
   // private    JEP miEvaluador;
    ...
    private void initComponents() {
        ...
        inicial.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(fun)
                    .addComponent(valor)
                    .addComponent(inicial, javax.swing.GroupLayout.DEFAULT_SIZE, 159, Short.MAX_VALUE))
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        String eval=fun.getText();
        String ini=inicial.getText();
        double d=Double.parseDouble(ini);
        funcion hard = new funcion(eval);
        double r=hard.evaluar(d);
        valor.setText(""+r);
